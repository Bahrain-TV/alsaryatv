        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                ...
                @php
                    ...
                    $ramadanDate = config('alsarya.ramadan.start_date', '2026-02-28');
                @endphp
                <div class="mt-3 flex flex-wrap gap-2">
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-800 dark:bg-amber-500/20 dark:text-amber-400">
                        ...
                        رمضان {{ \Carbon\Carbon::parse($ramadanDate)->format('Y') }}
                    </span>
                    ...
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-sky-100 text-sky-800 dark:bg-sky-500/20 dark:text-sky-400" title="إصدار التطبيق">
                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
