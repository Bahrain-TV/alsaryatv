...
use App\Providers\MailEnvironmentServiceProvider;
...
return [
    ...
    */
    ...
    'providers' => [
        ...
        ViewServiceProvider::class,  // Make sure this is earlier in the list
         ...
         */
        MailEnvironmentServiceProvider::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Add the ViewBootstrapper to properly initialize the Blade compiler
    | before package discovery attempts to use it.
    |
    */
